...
WINDOWS_ASSET_URL='https://github.com/quanking123456/Codex-Dream-Skin-Motion/blob/main/windows/assets/'
...
for file in "$DOCS_TARGET"/*.md; do
  ...
  /usr/bin/sed \
    ...
    -e "s#https://github.com/quanking123456/Codex-Dream-Skin-Motion/tree/main/windows/assets/#${WINDOWS_ASSET_TOKEN}#g" \
