...
function Get-DreamSkinText {
  ...
  $catalog = @{
    'en-US' = @{
      ...
      BackgroundUpdated = 'Background image updated.'; ChangeVideo = 'Choose video background...'
      VideoTitle = 'Choose a Codex Dream Skin video background'; VideoUpdated = 'Video background updated.'
      ...
      VideoFilter = 'MP4 video|*.mp4|All files|*.*'
    ...
    'zh-CN' = @{
      ...
      BackgroundUpdated = '背景图已更新。'; ChangeVideo = '选择动态背景…'
      VideoTitle = '选择 Codex Dream Skin 动态背景'; VideoUpdated = '动态背景已更新。'
      ImportZip = '导入主题 ZIP…'
